...
public class ProyectoFinalCountdownApplication {
	...
	public CommandLineRunner demoData(ICategoriaService categoriaSrv, IViajeService viajeSrv,
		...
		return args -> {
			...
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 1").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(1)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 2").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(1)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 3").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(1)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 4").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(1)).build());

			// Viajes categoria 2 - Familia
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 1").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(2)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 2").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(2)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 3").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(2)).build());
			...
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 1").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(3)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 2").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(3)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 3").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(3)).build());
			...
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 1").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(4)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 2").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(4)).build());
			viajeSrv.guardar(Viaje.builder().nombre("Viaje 3").descripcion("descripcion").precio(0.0)
					.vestuarioExtra(true).reportajeExtra(true).categoria(categoriaSrv.getCategoria(4)).build());
			...
			// Cliente - viaje 1
			clienteSrv.guardar(Cliente.builder().nombre("nombre").apellidos("apellidos").imagenDni("imagenDni")
					.fechaSalida(LocalDate.parse("2022-10-10")).fechaRegreso(LocalDate.parse("2022-10-11"))
					.telefono("telefono").email("email").viaje(viajeSrv.getViaje(1)).build());
