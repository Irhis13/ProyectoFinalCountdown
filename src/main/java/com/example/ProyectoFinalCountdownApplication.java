...
///////////////////////// COMENTAMOS XQ YA NO NECESITAMOS LA GENERACIÓN DE LA ENCRIPTACIÓN //////////	
	...
	public CommandLineRunner demoData(ICategoriaService categoriaSrv, IViajeService viajeSrv, IClienteService clienteSrv){
		return args ->{
			...
			.precio(2386.0).categoria(categoriaSrv.getCategoria(3)).build());
			...
			.precio(2125.0).categoria(categoriaSrv.getCategoria(3)).build());
			...
			.precio(2125.0).categoria(categoriaSrv.getCategoria(4)).build());
